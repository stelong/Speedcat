...
rat = "sham" # possible rat phenotype choices are "sham" and "ab"
freq = 6 # possible Hz choices are 1 and 6
n_beats = 10000 # number of cardiac cycles to simulate
n_curves = 10 # number of limit cardiac cycles to observe
